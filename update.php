...
$id = $_GET["id"];
$siswa = query("SELECT * FROM siswa_sekolah WHERE id = $id")[0];
    ...
    <div class="card-body">
      ...
      <input type="hidden" name="gambarLama" value="<?= $siswa['gambar']?>">
        <div class="form-group">
          ...
          <input type="text" name="nama" class="form-control" id="nama" required value="<?= $siswa['nama']?>">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="email" class="form-control" id="email" required value="<?= $siswa['email']?>">
        </div>

        <div class="form-group">
          <label for="gambar">Gambar :</label> <br>
          <input type="file" name="gambar" id="gambar" required value="<?= $siswa['gambar']?>">
        </div>
        <!-- button -->
